...
namespace EShop.Migrations
{
    ...
    [Migration("20241012150125_UpdateShippingCost_OrderModel")]
    partial class UpdateShippingCost_OrderModel
    {
            ...
            modelBuilder.Entity("EShop.Models.RatingModel", b =>
                {
                    b.HasOne("EShop.Models.ProductModel", "Product")
                        .WithOne("Ratings")
                        .HasForeignKey("EShop.Models.RatingModel", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
